...
<template>
  <footer class="border-t border-white/5 bg-st-black pt-24 text-white">
      ...
      <div class="grid grid-cols-1 gap-16 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="space-y-6 text-center md:text-left">
          ...
          <ul class="space-y-4 text-sm font-medium text-gray-400">
            ...
            <li>
              <NuxtLink to="/catalogue?cat=parfums" class="transition-colors hover:text-primary-soft">Haute parfumerie</NuxtLink>
            </li>
            <li>
              <NuxtLink to="/catalogue?cat=mode" class="transition-colors hover:text-primary-soft">Mode &amp; accessoires</NuxtLink>
            </li>
          </ul>
        </div>
        <div class="space-y-6 text-center md:text-left">
          ...
          <ul class="space-y-4 text-sm font-medium text-gray-400">
            ...
            <li>
              <NuxtLink to="/cgv" class="transition-colors hover:text-primary-soft">CGV</NuxtLink>
            </li>
            <li>
              <a href="https://wa.me/221770000000" target="_blank" rel="noopener noreferrer" class="transition-colors hover:text-primary-soft">WhatsApp concierge</a>
            </li>
          </ul>
        </div>
